...
#         # print ("DJKSJSAKFJASFKJAFKASJFKASJFKASJFKASJFKASFJASKFJASKJFSKFJSAKFJASKJFSAKFJSAKFJSKJFASKFJKjf")
...
#         # ,  empID = list_personal[0][0])
    
    
#     #empID = request.form['empID']
#     empID = request.args.get('id')
#     print(empID)
#     # return render_template('prac4.html',row_personal = list_personal, row_tasks = list_tasks,  empID = list_personal[0][0])
#     #should be improved coz after sublission prac4 details arnt being shown = completed
#     xyz = InfoTask(request.form["empID"], request.form["source"], request.form["reportedTo"], request.form["description"], request.form["weightage"], request.form["duration"], request.form["rating"])
#     #print(xyz)
#     db.session.add(xyz)
#     db.session.commit()
